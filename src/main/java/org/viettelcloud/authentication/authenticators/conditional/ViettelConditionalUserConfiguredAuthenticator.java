...
@JBossLog
public class ViettelConditionalUserConfiguredAuthenticator implements ConditionalAuthenticator {
    public static final ViettelConditionalUserConfiguredAuthenticator SINGLETON = new ViettelConditionalUserConfiguredAuthenticator();

    public boolean emailOTP = Boolean.parseBoolean(null);

    @Override
    public boolean matchCondition(AuthenticationFlowContext context) {

        log.info("ViettelConditionalUserConfiguredAuthenticator matchCondition");

        boolean result = matchConditionInFlow(context, context.getExecution().getParentFlow());
